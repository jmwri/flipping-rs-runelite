...
/**
 * The Trades tab: the newest fills as the journal has them.
 *
 * <p>The server's rows, not the plugin's: what is drawn here is what was
 * actually recorded, which is the only way a user can tell the difference
 * between a trade that was sent and one that was kept.
 */
final class TradesTab extends SidebarTab
{
